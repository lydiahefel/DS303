...
The model is not great given that it runs with about 48.35% accuracy. The low p-value indicates that the average number of rooms per dwelling is statistically significant in predicting the median value of owner-occupied homes in \$1000s.
...
The model is quite inaccurate given that it runs with about 25.78% accuracy. The low p-value indicates that the pupil-teacher ratio by town is statistically significant in predicting the median value of owner-occupied homes in \$1000s.
